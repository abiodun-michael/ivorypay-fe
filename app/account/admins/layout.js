...
import { getPageTitle, setToken } from '../../../redux/slices/app'
...
export default function Layout({children}) {
  ...
  const dispatch = useDispatch()
    ...
    const user = {
      ...
      const navigation = [
        { name: 'Admins', href: '/account/admins', current: title === 'Admins' },
        { name: 'Users', href: '/account/admins/users', current: title === 'Users' }
      ]
      ...
      const {loading} = useQuery('admins/auths/profile',{
        onComplete(payload){
